...
add CONSTRAINT CUSTOMER_ID_FK FORIGN KEY (CUSTOMER_ID) REFERENCES Customer(CUSTOMER_ID);
--Alter Supplier Status--
ALTER TABLE SUPPLIER STATUS
add CONSTRAINT SUPPLIER_ID_FK FORIGN KEY (SUPPLIER_ID) REFERENCES SUPPLIER(SUPPLIER_ID);
