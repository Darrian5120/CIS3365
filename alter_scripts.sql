...
add CONSTRAINT SERVICE_ID_FK2 FOREIGN KEY (SERVICE_ID) REFERENCES SERVICE_REQUEST(SERVICE_ID),
CONSTRAINT V_VIN_FK1 FOREIGN KEY (V_VIN) REFERENCES VEHICLE(V_VIN),
...
add CONSTRAINT SERVICE_ID_FK3 FOREIGN KEY (SERVICE_ID) REFERENCES SERVICE_REQUEST(SERVICE_ID);
...
add CONSTRAINT SERVICE_LINE_ID_FK FOREIGN KEY (SERVICE_LINE_ID) REFERENCES EMPLOYEE_SERVICE_LINE_ASSINGMENT(SERVICE_LINE_ID);
------------------Maddy------------------------------------------------------------------------------
...
add CONSTRAINT SERVICE_ORDER_ID_FK3 FOREIGN KEY (SERVICE_ORDER_ID) REFERENCES SERVICE_LINE(SERVICE_ORDER_ID);
------------------------------Gian---------------------------------------------------
...
add CONSTRAINT SUP_PART_ID_FK2 FOREIGN KEY (SUP_PART_ID) REFERENCES SUPPLIER_PART(SUP_PART_ID),
...
add CONSTRAINT VIOLATION_ID_FK FOREIGN KEY (VIOLATION_ID) REFERENCES STATE_VIOLATION(VIOLATION_ID),
