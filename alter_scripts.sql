...
add CONSTRAINT SERVICE_ORDER_ID1_FK1 FOREIGN KEY (SERVICE_ORDER_ID1) REFERENCES SERVICE_ORDER(SERVICE_ORDER_ID), --FIXME--
CONSTRAINT SERVICE_ORDER_ID2_FK1 FOREIGN KEY (SERVICE_ORDER_ID2) REFERENCES SERVICE_ORDER(SERVICE_ORDER_ID), --FIXME--
...
CONSTRAINT SERVICE_ID2_FK FOREIGN KEY (SERVICE_ID2) REFERENCES SERVICE(SERVICE_ID),
CONSTRAINT SERVICE_ID3_FK FOREIGN KEY (SERVICE_ID3) REFERENCES SERVICE(SERVICE_ID);
