...
add CONSTRAINT ACTIVE_ID_FK1 FOREIGN KEY (ACTIVE_ID) REFERENCES SERVICE_LINE(ACTIVE_ID);
ALTER TABLE VEHICLE_STATUS
add CONSTRAINT ACTIVE_ID_FK6 FOREIGN KEY (ACTIVE_ID) REFERENCES VEHICLE(ACTIVE_ID);
