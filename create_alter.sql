...
CREATE TABLE dbo.INVOICE_PAYMENT (
	...
	ACTIVE_ID INT NOT NULL,
	CONSTRAINT IP_NUMBER_PK1 PRIMARY KEY (PMT_ID, INVOICE_ID,SERVICE_ORDER_ID, SERVICE_ID)
);
-----------------Anthony-------------------------------
...
CREATE TABLE dbo.INVOICE (
	...
	AMT_OWED MONEY,
	ACTIVE_ID INT NOT NULL,
	CONSTRAINT INVOICE_ID_PK PRIMARY KEY (INVOICE_ID, SERVICE_ORDER_ID, SERVICE_ID)
);
------------------Mustafa-----------------------------------------------
--Service Line Status--
...
CONSTRAINT SERVICE_ID_FK2 FOREIGN KEY (SERVICE_ID) REFERENCES SERVICE(SERVICE_ID),
...
CONSTRAINT INVOICE_ID_FK2 FOREIGN KEY (INVOICE_ID) REFERENCES INVOICE(INVOICE_ID, SERVICE_ORDER_ID, SERVICE_ID),
CONSTRAINT SERVICE_ORDER_ID_FK1 FOREIGN KEY (SERVICE_ORDER_ID) REFERENCES INVOICE(INVOICE_ID, SERVICE_ORDER_ID, SERVICE_ID), 
CONSTRAINT SERVICE_ID_FK2 FOREIGN KEY (SERVICE_ID) REFERENCES INVOICE(INVOICE_ID, SERVICE_ORDER_ID, SERVICE_ID),
...
--Alter Invoice--
ALTER TABLE INVOICE
add CONSTRAINT SERVICE_ORDER_ID_FK1 FOREIGN KEY (SERVICE_ORDER_ID) REFERENCES SERVICE_LINE(SERVICE_ORDER_ID, SERVICE_LINE), 
CONSTRAINT SERVICE_ID_FK2 FOREIGN KEY (SERVICE_ID) REFERENCES SERVICE_LINE(SERVICE_ORDER_ID, SERVICE_LINE),
...
CONSTRAINT PMT_ID_FK6 FOREIGN KEY (PMT_ID, INVOICE_ID) REFERENCES INVOICE_PAYMENT(PMT_ID, INVOICE_ID,SERVICE_ORDER_ID, SERVICE_ID),
CONSTRAINT INVOICE_ID_FK2 FOREIGN KEY (INVOICE_ID) REFERENCES INVOICE_PAYMENT(PMT_ID, INVOICE_ID,SERVICE_ORDER_ID, SERVICE_ID),
CONSTRAINT SERVICE_ORDER_ID_FK1 FOREIGN KEY (SERVICE_ORDER_ID) REFERENCES INVOICE_PAYMENT(PMT_ID, INVOICE_ID,SERVICE_ORDER_ID, SERVICE_ID), 
CONSTRAINT SERVICE_ID_FK2 FOREIGN KEY (SERVICE_ID) REFERENCES INVOICE_PAYMENT(PMT_ID, INVOICE_ID,SERVICE_ORDER_ID, SERVICE_ID),
...
add CONSTRAINT SERVICE_LINE_ID_FK FOREIGN KEY (SERVICE_LINE_ID, SERVICE_ORDER_ID, SERVICE_ID) REFERENCES SERVICE_LINE(SERVICE_ORDER_ID, SERVICE_ID),
CONSTRAINT EMPLOYEE_ID_FK3 FOREIGN KEY (EMPLOYEE_ID) REFERENCES EMPLOYEE(EMPLOYEE_ID);
ALTER TABLE SERVICE_LINE_PART
add CONSTRAINT SERVICE_LINE_ID_FK2 FOREIGN KEY (SERVICE_LINE_ID, SERVICE_ORDER_ID, SERVICE_ID) REFERENCES SERVICE_LINE(SERVICE_ORDER_ID, SERVICE_ID),
