...
CONSTRAINT SERVICE_ORDER_ID_FK1 FOREIGN KEY (SERVICE_ORDER_ID) REFERENCES INVOICE(SERVICE_ORDER_ID), 
CONSTRAINT SERVICE_ID_FK2 FOREIGN KEY (SERVICE_ID) REFERENCES INVOICE(SERVICE_ID),
