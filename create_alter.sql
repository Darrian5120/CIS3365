...
--customer contact DO NOT INCLUDE--
...
CONSTRAINT CONDITION_ID_FK FOREIGN KEY (CONDITION_ID) REFERENCES VEHICLE_CONDITION(CONDITION_ID),
CONSTRAINT MAKE_ID_FK FOREIGN KEY (MAKE_ID) REFERENCES MAKE,
CONSTRAINT MODEL_ID_FK FOREIGN KEY (MODEL_ID) REFERENCES MODEL;
