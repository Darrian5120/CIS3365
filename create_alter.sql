...
create table dbo.PAYMENT_REVENUE(
	...
	CONSTRAINT REVENUE_ID_PK1 PRIMARY KEY (REVENUE_ID, PMT_ID, INVOICE_ID, SERVICE_ORDER_ID, SERVICE_ID)
);
------------Jahidul---------------------------------------------------
...
CONSTRAINT INVOICE_ID_FK FOREIGN KEY (INVOICE_ID, SERVICE_ORDER_ID, SERVICE_ID) REFERENCES INVOICE,
...
--Alter Invoice--
ALTER TABLE INVOICE
add CONSTRAINT SL_ID_FK FOREIGN KEY (SERVICE_ORDER_ID, SERVICE_ID) REFERENCES SERVICE_LINE,
...
CONSTRAINT PR_ID_FK6 FOREIGN KEY (PMT_ID, INVOICE_ID, SERVICE_ORDER_ID, SERVICE_ID) REFERENCES INVOICE_PAYMENT;
...
add CONSTRAINT SERVICE_LINE_ID_FK FOREIGN KEY (SERVICE_LINE_ID, SERVICE_ORDER_ID, SERVICE_ID) REFERENCES SERVICE_LINE,
CONSTRAINT EMPLOYEE_ID_FK3 FOREIGN KEY (EMPLOYEE_ID) REFERENCES EMPLOYEE(EMPLOYEE_ID);

ALTER TABLE SERVICE_LINE_PART
add CONSTRAINT SERVICE_LINE_ID_FK2 FOREIGN KEY (SERVICE_LINE_ID, SERVICE_ORDER_ID, SERVICE_ID) REFERENCES SERVICE_LINE,
